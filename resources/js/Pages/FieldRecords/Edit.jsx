...
export default function Edit({ fieldRecord, auth }) {
    const { data, setData, put, processing, errors } = useForm({
        date: fieldRecord.date || '',
        hours: fieldRecord.hours || '',
        bible_studies: fieldRecord.bible_studies || '',
        placements: fieldRecord.placements || '',
    });

    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('field-records.update', fieldRecord.id));
    };
