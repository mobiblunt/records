    ...
    return (
        <>
            ...
            <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100 dark:bg-gray-900">
                <div className="w-full max-w-md p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg flex flex-col items-center">
                    <svg
                        viewBox="0 0 62 65"
                        fill="none"
                    ...
                    >
                        <circle cx="31" cy="32.5" r="30" fill="#fff" className="dark:fill-gray-800" />
                        <path
                ...
                <div className="mt-8 text-gray-400 text-xs">
                    &copy; {new Date().getFullYear()} Ministry Records
                </div>
            </div>
